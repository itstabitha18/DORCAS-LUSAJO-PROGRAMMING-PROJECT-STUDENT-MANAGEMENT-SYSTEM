...
{  
  system("CLS");
	cout << "***********======================***********" << endl;
	cout << "\t WELCOME TO SHULE APP " << endl << endl;
...
void updateStudentStatus(int studentIndex) {
    ...
    res[studentIndex].total = res[studentIndex].subject1 + res[studentIndex].subject2 + res[studentIndex].subject3
    				+ res[studentIndex].subject4 +res[studentIndex].subject5; 
    
    res[studentIndex].average = res[studentIndex].total / 5;
    
	if(res[studentIndex].subject1 <= 100 || res[studentIndex].subject1 >= 80 )
    {
		res[studentIndex].reward = "A";
	}
	
	if(res[studentIndex].subject1 <= 79 || res[studentIndex].subject1 >= 60 )
	{
		res[studentIndex].reward = "B";
	}
	
	if(res[studentIndex].subject1 <= 59 || res[studentIndex].subject1 >= 40)
	{
		res[studentIndex].reward = "C";
	}
	
	if(res[studentIndex].subject1 <= 49 || res[studentIndex].subject1 >= 20 )
	{
		res[studentIndex].reward = "D";
	}
	
	if(res[studentIndex].subject1 <= 19 || res[studentIndex].subject1 >= 0 )
	{
		res[studentIndex].reward = "F";
	}
	
		if(res[studentIndex].subject2 <= 100 || res[studentIndex].subject1 >= 80 )
    {
		res[studentIndex].reward = "A";
	}
	
	if(res[studentIndex].subject2 <= 79 || res[studentIndex].subject1 >= 60 )
	{
		res[studentIndex].reward = "B";
	}
	
	if(res[studentIndex].subject2 <= 59 || res[studentIndex].subject1 >= 40)
	{
		res[studentIndex].reward = "C";
	}
	
	if(res[studentIndex].subject2 <= 49 || res[studentIndex].subject1 >= 20 )
	{
		res[studentIndex].reward = "D";
	}
	
	if(res[studentIndex].subject2<= 19 || res[studentIndex].subject1 >= 0 )
	{
		res[studentIndex].reward = "F";
	}

	if(res[studentIndex].subject3 <= 100 || res[studentIndex].subject1 >= 80 )
    {
		res[studentIndex].reward = "A";
	}
	
	if(res[studentIndex].subject3 <= 79 || res[studentIndex].subject1 >= 60 )
	{
		res[studentIndex].reward = "B";
	}
	
	if(res[studentIndex].subject3 <= 59 || res[studentIndex].subject1 >= 40)
	{
		res[studentIndex].reward = "C";
	}
	
	if(res[studentIndex].subject3 <= 49 || res[studentIndex].subject1 >= 20 )
	{
		res[studentIndex].reward = "D";
	}
	
	if(res[studentIndex].subject3 <= 19 || res[studentIndex].subject1 >= 0 )
	{
		res[studentIndex].reward = "F";
	}

	if(res[studentIndex].subject4 <= 100 || res[studentIndex].subject1 >= 80 )
    {
		res[studentIndex].reward = "A";
	}
	
	if(res[studentIndex].subject4 <= 79 || res[studentIndex].subject1 >= 60 )
	{
		res[studentIndex].reward = "B";
	}
	
	if(res[studentIndex].subject4 <= 59 || res[studentIndex].subject1 >= 40)
	{
		res[studentIndex].reward = "C";
	}
	
	if(res[studentIndex].subject4 <= 49 || res[studentIndex].subject1 >= 20 )
	{
		res[studentIndex].reward = "D";
	}
	
	if(res[studentIndex].subject4 <= 19 || res[studentIndex].subject1 >= 0 )
	{
		res[studentIndex].reward = "F";
	}

	if(res[studentIndex].subject5 <= 100 || res[studentIndex].subject1 >= 80 )
    {
		res[studentIndex].reward = "A";
	}
	
	if(res[studentIndex].subject5 <= 79 || res[studentIndex].subject1 >= 60 )
	{
		res[studentIndex].reward = "B";
	}
	
	if(res[studentIndex].subject5 <= 59 || res[studentIndex].subject1 >= 40)
	{
		res[studentIndex].reward = "C";
	}
	
	if(res[studentIndex].subject5 <= 49 || res[studentIndex].subject1 >= 20 )
	{
		res[studentIndex].reward = "D";
	}
	
	if(res[studentIndex].subject5 <= 19 || res[studentIndex].subject1 >= 0 )
	{
		res[studentIndex].reward = "F";
	}
